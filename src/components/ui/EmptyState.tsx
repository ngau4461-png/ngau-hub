...
import { FolderOpen, BookOpen, Star, Search, Link2, Settings as SettingsIcon } from 'lucide-react'
...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  const Icon = iconMap[(icon as unknown as string)] || icon
  return (
    <div
      className={cn(
  ...
  return (
    <div role="status" className="flex items-center justify-center p-4">
      <svg
        ...
        className={cn(
          sizeMap[size],
          'text-gray-200 dark:text-gray-700 animate-spin fill-primary-600',
          className
        )}
        viewBox="0 0 100 101"
        fill="none"
